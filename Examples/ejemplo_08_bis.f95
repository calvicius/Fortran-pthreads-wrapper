...
program main
    ...
    integer(kind=c_size_t), target :: stacksize, stackbase, stackGet
    integer             :: rc
    ...
    do t = 1, NTHREADS
        ...
        stackGet = 0
        print *, "linea 116 ", rc, stackGet, c_loc(stackGet)
        rc = pthread_attr_getstackaddr(ptr_attr, c_loc(stackGet))  ! 0 = OK, /= 0 --> Err
        print *, "linea 118 ", rc, c_loc(stackbase)
    end do
